...
$app->get('/like/{id}/{type}[/{idTag}]', 'App\Controllers\PictureController:like')->setName('like')->add('checkAuthentication');
$app->get('/dislike/{id}/{type}[/{idTag}]', 'App\Controllers\PictureController:dislike')->setName('dislike')->add('checkAuthentication');
